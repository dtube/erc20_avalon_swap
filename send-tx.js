// move file to node_modules/@openzeppelin/cli/lib/commands/send-tx.js
// allows to set gas price in CLI
...
const register = program => program
    ...
    .option('--price <price>', `gas price of the transaction, will default to the limit specified in the configuration file, or use gas estimation if not set`)
    .withNetworkOptions()
    .withNonInteractiveOption()
    .action(action);
function action(options) {
    return __awaiter(this, void 0, void 0, function* () {
        const { interactive, to: proxyAddress, value, gas, price } = options;
        ...
        if (price) txParams.gasPrice = price
        // console.log(txParams, price)
